...
<div class="container-fluid">
    <div class="pagetitle">
        <h1>Tambah Data Tingkat</h1>
    </div>
    <hr class="sidebar-divider">
    <a href="<?= base_url('Admin/index_data_tingkat'); ?>" class="btn btn-sm btn-primary mb-3"><i
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3 mt-1 needs-validation" action="<?= base_url('Admin/index_input_tingkat'); ?>"
                method="post">
