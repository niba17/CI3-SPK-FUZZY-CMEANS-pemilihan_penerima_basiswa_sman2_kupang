...
<div class="container-fluid">
    ...
    <a href="<?=base_url('Admin/index_input_tingkat');?>" class="btn btn-sm btn-primary mb-3">Tambah Data <i
...
foreach ($tingkat as $t): ?>
                        <tr>
                            ...
                            <td><?=$t->nama;?></td>
                            <td>
                                <a href="<?=base_url('Admin/index_ubah_data_tingkat/') . $t->id;?>"
                                    class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="#" class="btn btn-sm btn-primary"
                                    onclick="hapus_kelas('<?=$t->id?>','<?=$t->nama?>','tingkat')"><i
